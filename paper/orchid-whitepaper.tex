...
The reference interpreter is implemented in TypeScript, passes over 470 tests across 13 test suites, and is published on npm as \texttt{@orchid-dsl/orchid}. The full language specification, including an EBNF grammar, is published under the MIT license.
