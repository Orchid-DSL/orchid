...
- [x] **GitHub Actions CI.** Workflow running `npm test` + `npm run lint` on push/PR. Signals the project is serious and protects against regressions from contributors. *(Added in 6b446fd)*
